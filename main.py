...
def new_budget():
    ...
    annual_list = [annual_budget, out_file]
...
def continue_budget():
    ...
    gas = float(budget_data.readline().strip())
    phone = float(budget_data.readline().strip())
    loans = float(budget_data.readline().strip())    
    subscriptions = float(budget_data.readline().strip())
    num_month = float(budget_data.readline().strip())
    num_created_months = int(budget_data.readline().strip())

    annual_budget = Annual_Budget(income,groceries,utilities,housing, gas, phone, loans, 
                                    subscriptions, num_month)
